...
public class ColorSpecificationTK extends Commonactions {
    ...
    public void userNavigatesToCanvasTab() throws Throwable {
        try {
            ...
            ca.click(spec.getSpecificationTab());
            jsWaitForPageLoad();
            if(lp.getRightArrowBtn().isDisplayed()) {
                Commonactions.isElementPresent(lp.getRightArrowBtn());
                ca.click(lp.getRightArrowBtn());
            }
            waitForElementClickable(spec.getTemplateTab());
        ...
        System.out.println("Navigated to canvas page");
    }
    ...
    public void userNavigatesToLibrariesTab() throws Throwable {
        ...
        ca.eleToBeClickable();
        actions.moveToElement(shp.getLibrariesTab()).click(shp.getLibrariesTab()).build().perform();
        jsWaitForPageLoad();
    ...
    public void userNavigatesToSizeCanvasTab() throws Throwable {
        ...
        System.out.println("Navigated to SizeChart canvas page");
    }
    ...
    public void userCreatesTheSizeChartCanvas(String a) throws Throwable {
        ...
        for (int i = 0; i <SizeChartName.length ; i++) {
            ...
            actions.sendKeys(Keys.ENTER).build().perform();
            Thread.sleep(2500);
            WebElement PG = driver.findElement(By.xpath("(//a[@class='browse' and text()='" + SizeChartName[i] + "']//following::td[@data-csi-act='Group:Child:CurrentRevision:0'])[1]"));
            Thread.sleep(2500);
    ...
    public void userCreatesTheDimensionInsideTheCanvas(String a) throws Throwable {
        ...
        sizeChartName.click();
        jsWaitForPageLoad();
        waitForElementClickable(sk.getBaseSizeBtn());
        ca.click(sk.getBaseSizeBtn());
        Actions actions = new Actions(driver);
        actions.sendKeys(Keys.ARROW_UP).build().perform();
        actions.sendKeys(Keys.ENTER).build().perform();
        Thread.sleep(2000);
        ...
        waitForElementClickable(sk.getAllDimBtn());
    ...
    public void userNavigatesToTemplateTab() throws Throwable {
        ...
        System.out.println("Navigated to template page");
    }
